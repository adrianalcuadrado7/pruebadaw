...
public class ControladorModificarVotante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {        
            new Operaciones().modificarVotante(Conexion, objVotante);
            response.sendRedirect("Vistas/VistaMensajes.jsp?mensaje=Datos modificados correctamente&donde=1");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ControladorModificarVotante</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ControladorModificarVotante at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
