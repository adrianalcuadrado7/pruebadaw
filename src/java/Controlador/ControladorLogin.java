...
public class ControladorLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {        
          Votante votante =  new Operaciones().login(Conexion,objVotante);
          Informacion info= new Operaciones().informacion(Conexion);
          ArrayList<Partido> p= new Operaciones().partidos(Conexion);
          HttpSession session= request.getSession(true);
          session.setAttribute("Votante", votante);
          session.setAttribute("ObjInformacion",info);
          session.setAttribute("Partidos", p);
